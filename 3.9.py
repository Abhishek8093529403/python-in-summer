...
# Oh no, the table is not available
print("\n Sorry, we can only invite two people to dinner.\n")

print("Sorry, " + guest.pop() + " there's no room at the table.")
print("Sorry, " + guest.pop() + " there's no room at the table.")
print("Sorry, " + guest.pop() + " there's no room at the table.")
print("Sorry, " + guest.pop() + " there's no room at the table.\n")

#two people left. Let's invite them.

print(guest[0] + ", please come to dinner.")
print(guest[1] + ", please come to dinner.\n")

print(str(len(guest))+ " peoples are invited to dinner.")
